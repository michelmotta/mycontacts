...
class TypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-01-28 02:25:14',
            'modified' => '2017-01-28 02:25:14'
        ],
    ];
}
