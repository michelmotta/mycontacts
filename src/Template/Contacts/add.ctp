        ...
        <div class="contacts form large-9 medium-8 columns content">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php echo $this->Form->input('phone_one', ['label' => __('Fone 1'), 'class' => 'form-control phone']); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <?php echo $this->Form->input('phone_two', ['label' => __('Fone 2'), 'class' => 'form-control phone']); ?>
                    </div>
                    <div class="col-md-4">
                        <?php echo $this->Form->input('phone_tree', ['label' => __('Fone 3'), 'class' => 'form-control phone']); ?>
                    </div>
                    <div class="col-md-4">
                        <?php echo $this->Form->input('special_phone', ['label' => __('Fone Especial'), 'class' => 'form-control phone']); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
